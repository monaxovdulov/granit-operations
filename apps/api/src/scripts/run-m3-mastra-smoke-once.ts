...
const SMOKE_IDEMPOTENCY_KEY = "m3-mastra-smoke-20260715-002";
...
try {
  ...
  const response = await app.inject({
    ...
    payload: {
      ...
      submitted_at: "2026-07-15T16:30:00.000Z",
      source: {
        channel: "site_widget",
        page_url: "https://botops.ru/m3-synthetic-smoke-002",
        widget_instance_id: "m3-synthetic-smoke-002"
      },
      message: {
        role: "visitor",
