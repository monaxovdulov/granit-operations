...
- `TELEGRAM_MANAGER_REPLY_WORKER_SUPERVISED_SCHEDULER_RU.md` - supervised one-shot scheduler implementation evidence; local checks passed, production approval remains blocked.
