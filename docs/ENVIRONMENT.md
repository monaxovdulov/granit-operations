...
| `PUBLIC_INTAKE_ALLOWED_ORIGINS` | Comma-separated exact HTTP(S) origins allowed to call `/public/intake/*`; for staging RC use `https://preview.granitkr.ru` | server only | public intake runtime, default closed |
